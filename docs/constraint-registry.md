...
| P1_MAIN_SPREAD | negotiable policy | Main subjects should be spread across days | weighted penalty | yes | implemented |
| S1_TEACHER_SLOT | soft preference | Honour explicit prefer/avoid slots | weighted penalty | yes | implemented |
